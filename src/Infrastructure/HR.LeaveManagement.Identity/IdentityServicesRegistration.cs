...
public static class IdentityServicesRegistration
{
    ...
    {
        // Add Identity services configuration here if needed
        services.Configure<JwtSettings>(configuration.GetSection("JwtSettings"));
        services.AddDbContext<LeaveManagementIdentityDbContext>(options => options.UseSqlite(configuration.GetConnectionString("LeaveManagementIdentityConnectionString"),
